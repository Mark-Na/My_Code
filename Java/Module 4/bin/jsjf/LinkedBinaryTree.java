...
//This application creates a binary tree using linked lists and tests all the various methods
 ...
 * @version 4.0
 */
//referenced source file given(sourcefile)
public class LinkedBinaryTree<T> implements BinaryTreeADT<T>, Iterable<T>
{
	...
	public int size() 
	{
		return root.numChildren()+1;//from the BinaryTreeNode class	+1 to include the root	
	}
	...
	public String toString() 
	{
		...
		//just used the given iterator to represent the tree
	 ...
	 */
	//edited used the inOrder method as a base for all these iterator methods
